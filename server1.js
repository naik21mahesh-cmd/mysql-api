...
const db = mysql.createConnection({
  host: 'roupdarshan.com', // Your MySQL host
  user: 'u441460640_appdemo', // Your MySQL username
  password: '!dea10Nil', // Your MySQL password
  database: 'u441460640_appdemo' // Your database name
